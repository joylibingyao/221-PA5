...
public class Oval extends Shape{
    ...
    public Oval(int currentSTX, int currentSTY, int currentEDX, int currentEDY,boolean isFilled ,boolean isGradient,Color firstCol ,Color secondCol,int lineWidth,boolean isDashed,int dashLength) {
